"""Single-sample inference entry point for Exp-02 — Transformer.
...
LOGGER = get_logger("exp_02_transformer.inference")
...
def main() -> None:
    ...
    raise SystemExit(
        "exp_02_transformer/inference.py is a runnable skeleton; migrate the real pipeline."
    )
