"""Evaluation entry point for Exp-02 — Transformer.

Computes Top-1 / Top-5 accuracy on the EgSL-5K test split.
Reported results for this experiment: Top-1 6.56%, Top-5 22.40% (Rejected).
...
LOGGER = get_logger("exp_02_transformer.evaluate")
...
def main() -> None:
    ...
    _ = top_k_accuracy
    raise SystemExit(
        "exp_02_transformer/evaluate.py is a runnable skeleton; migrate the real eval loop."
    )
