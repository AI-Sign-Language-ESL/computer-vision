"""Transformer model definition for Exp-02 — Transformer.

TODO(manual-review): replace this placeholder with the original Transformer
...
class TransformerClassifier(_BASE):
    """Placeholder Transformer classifier.
    ...
    def forward(self, x):  # noqa: D401 - placeholder
        raise NotImplementedError(
            "TransformerClassifier.forward is a placeholder; migrate the real architecture."
        )
