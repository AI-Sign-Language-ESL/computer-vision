"""VideoMAE model definition for Exp-03 — VideoMAE.

TODO(manual-review): replace this placeholder with the original VideoMAE
...
class VideoMAEClassifier(_BASE):
    """Placeholder VideoMAE classifier.
    ...
    def forward(self, x):  # noqa: D401 - placeholder
        raise NotImplementedError(
            "VideoMAEClassifier.forward is a placeholder; migrate the real architecture."
        )
