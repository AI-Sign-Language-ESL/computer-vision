"""SPOTER model definition for Exp-04 — SPOTER.

TODO(manual-review): replace this placeholder with the original SPOTER
...
class SPOTER(_BASE):
    ...
    def forward(self, x):  # noqa: D401 - placeholder
        raise NotImplementedError(
            "SPOTER.forward is a placeholder; migrate the real architecture."
        )
